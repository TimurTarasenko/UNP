...
ActiveRecord::Schema.define(version: 20170402211007) do
  ...
  create_table "folders", force: :cascade do |t|
    ...
    t.index ["user_group_id"], name: "index_folders_on_user_group_id", using: :btree
  ...
  create_table "phone_numbers", id: false, force: :cascade do |t|
    t.string   "day_id",        limit: 20,           null: false
    t.string   "country",       limit: 50,           null: false
    t.bigint   "phone_number"
    t.string   "interfaces",    limit: 20
    t.datetime "start_call"
    t.bigint   "duration_call"
    t.money    "costs",                    scale: 2
  ...
  create_table "tezs", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "use_phone_systems", force: :cascade do |t|
    t.datetime "day_id"
    t.string   "country"
    t.bigint   "phone_number"
    t.string   "interfaces"
  ...
  create_table "usevs", force: :cascade do |t|
    ...
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.index ["email"], name: "index_usevs_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_usevs_on_reset_password_token", unique: true, using: :btree
  end
